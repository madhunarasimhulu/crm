const banks = {
  ...
  '079': 'Banco Original do Agronegécio S.A.',
  '081': 'BBN Banco Brasileiro de Negócios S.A.',
  '082': 'Banco Topázio S.A.',
  '083': 'Banco da China Brasil S.A.',
  '084':
    'Uniprime Norte do Paraná - Coop de Economia e Crádito Mútuo dos Médicos, Profissionais das Ciências',
  ...
  136: 'CONFEDERACAO NACIONAL DAS COOPERATIVAS CENTRAIS UNICREDS Ltda.',
  ...
  '090-2': 'Cooperativa Central de Economia e Crédito Mútuo - SICOOB UNIMAIS',
...
const getBankNameByCode = (code) => banks[code];

export default getBankNameByCode;
